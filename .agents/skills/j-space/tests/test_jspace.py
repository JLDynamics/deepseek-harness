...
Taken from J-Space Cognition Suite V3.6 (tests/test_jspace.py); relocated into
the skill tree and adjusted so the controller is resolved relative to the
skill root (scripts/jspace.py) instead of a repo-root sibling directory.
"""
